                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="space-y-3 text-gray-500">
                            ...
                            <p>
                            <a href="mailto:setyaakbar33@gmail.com" class="hover:text-primary transition-colors">setyaakbar33@gmail.com</a>
                            </p>
                            <p>
                                <a href="tel:+6282124306742" class="hover:text-primary transition-colors">082124306742</a>
                            </p>
                        </div>
                    </div>

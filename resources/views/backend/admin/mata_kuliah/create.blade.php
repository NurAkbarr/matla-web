...
@section('breadcrumb', 'Akademik / Mata Kuliah / Tambah')

@section('content')
<div class="max-w-4xl bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-8 border-b border-gray-50 bg-gray-50/50">
        <h3 class="text-xl font-extrabold text-gray-900">Tambah Mata Kuliah</h3>
        <p class="text-sm text-gray-500 font-medium">Lengkapi formulir di bawah untuk mendaftarkan mata kuliah baru.</p>
    </div>

    <form action="{{ route('backend.admin.mata-kuliah.store') }}" method="POST" class="p-8 space-y-8">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-3">
                ...
                <input type="text" name="kode" id="kode" required 
                    ...
                    placeholder="Contoh: TI101" value="{{ old('kode') }}">
        ...
        <div class="space-y-3">
            ...
            <input type="text" name="nama" id="nama" required 
                ...
                placeholder="Contoh: Algoritma & Pemrograman I" value="{{ old('nama') }}">

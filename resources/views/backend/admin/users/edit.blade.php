...
<div class="max-w-2xl bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
    ...
    <form action="{{ route('backend.admin.users.update', $user) }}" method="POST" class="p-8 space-y-6" x-data="{ role: '{{ old('role', $user->role) }}' }">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="phone" id="phone" required 
                    ...
                    placeholder="Contoh: 08123456789" value="{{ old('phone', $user->phone) }}">
            ...
            <div class="space-y-2" x-show="role === 'dosen'">
                ...
                <input type="text" name="nidn" id="nidn"
                    ...
                    placeholder="Masukkan NIDN (Opsional)" value="{{ old('nidn', $user->nidn) }}">

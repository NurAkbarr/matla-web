...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
    <!-- Stat Card 1 -->
    <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-gray-100 flex items-center justify-between">
        <div>
        ...
        <div class="w-12 h-12 md:w-14 md:h-14 bg-emerald-50 text-primary rounded-2xl flex items-center justify-center flex-shrink-0">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-gray-100 flex items-center justify-between">
        ...
        <div class="w-12 h-12 md:w-14 md:h-14 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center flex-shrink-0">
            <svg class="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-gray-100 flex items-center justify-between">
        ...
        <div class="w-12 h-12 md:w-14 md:h-14 bg-orange-50 text-orange-600 rounded-2xl flex items-center justify-center flex-shrink-0">
            <svg class="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="mt-6 md:mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
    <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-gray-100">
        <h4 class="text-lg md:text-xl font-extrabold text-gray-900 mb-4 md:mb-6">Aktivitas Terakhir</h4>
        <div class="space-y-6">

                ...
                <tr class="group hover:bg-gray-50 transition-all">
                    ...
                    <td class="py-6 px-4">
                        <div class="flex items-center justify-end space-x-3">
                            ...
                            @endif
                            <a href="{{ route('backend.admin.jadwal.pertemuan.index', $jadwal) }}" class="p-2 text-blue-500 hover:bg-blue-50 rounded-lg transition-colors flex items-center space-x-1" title="Kelola Silabus & Pertemuan">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                                <span class="text-[10px] font-black uppercase tracking-tighter">{{ $jadwal->pertemuans()->count() }}</span>
                            </a>

        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                    ...
                    <input type="number" name="semester" value="{{ old('semester') }}" required class="w-full border-gray-200 rounded-2xl p-4 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200" placeholder="Contoh: 1">
                ...
                <div>
                    ...
                    <input type="text" name="angkatan" value="{{ old('angkatan') }}" required class="w-full border-gray-200 rounded-2xl p-4 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200" placeholder="Contoh: 2024">
            ...
            <div class="mt-6">
                ...
                <input type="number" name="sks" value="{{ old('sks', 2) }}" required class="w-full border-gray-200 rounded-2xl p-4 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200">

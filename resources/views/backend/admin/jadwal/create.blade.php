        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="semester" id="semester_input" value="{{ old('semester') }}" required class="w-full border-gray-200 rounded-2xl p-4 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200" placeholder="1">
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Angkatan</label>
                    <input type="text" name="angkatan" value="{{ old('angkatan') }}" required class="w-full border-gray-200 rounded-2xl p-4 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200" placeholder="2024">
                </div>
            </div>
        </div>

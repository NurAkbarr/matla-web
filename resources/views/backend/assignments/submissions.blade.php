    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
        ...
        <div class="flex flex-wrap items-center gap-3">
            @if($assignment->file_path)
                <a href="{{ route('foto.bypass', ['path' => $assignment->file_path]) }}" target="_blank" class="inline-flex items-center px-4 py-2.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold rounded-xl text-xs transition-colors">
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        @else
                                            @if($sub->submitted_file_path)
                                                <a href="{{ route('tugas.download', ['path' => $sub->submitted_file_path]) }}" target="_blank" class="inline-flex items-center text-xs font-bold text-emerald-600 hover:text-emerald-700">

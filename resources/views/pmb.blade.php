    ...
    <div class="container mx-auto px-4 lg:px-12">
        ...
        <div class="flex flex-col md:flex-row flex-wrap justify-center gap-8 md:gap-12">
            @forelse($brosurs as $brosur)
                <div class="w-full md:max-w-[320px] brochure-card-wrapper" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="brochure-card group relative bg-white rounded-[2.5rem] p-4 shadow-xl border border-gray-100 transition-all duration-500 hover:shadow-2xl h-full flex flex-col cursor-pointer" 
                            ...
                            <!-- Premium Frame -->
                            <div class="relative aspect-[4/3] rounded-[2rem] overflow-hidden mb-6 flex-shrink-0 bg-gray-50">
                                <img src="{{ asset('pmb-brosur/' . $brosur->image) }}" alt="{{ $brosur->title }}" class="w-full h-full object-contain transform group-hover:scale-105 transition-transform duration-700">
